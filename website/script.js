// Gift List Data
const gifts = [
    { title: "🎁 TESTE DE PRODUÇÃO (PagBank)", image: "" },
    ...
    { title: "Só pra não dizer que não dei nada", image: "mão de vaca.webp" },
    ...
    { title: "Ajuda para o felipe comprar um óculos novo de sol e largar o Juliete", image: "julietteana.webp" },
    { title: "Ajuda de custo para o felipe levar a Camila no estádio do Corinthians", image: "estadio.jpg" },
    { title: "Ajuda de custo para a Camila iniciar o tratamento contra aminesia", image: "esquecida.jpg" },
    ...
    { title: "Sentar próximo a mesa de doces", image: "meme casamento.jpg" },
    ...
    { title: "Taças de vinhos para noites românticas", image: "vinho.jpg" },
    { title: "Curso de Culinária para o a Camila deixar de explorar o Felipe", image: "cozinha fogo.webp" },
    { title: "Shaampo antiqueda para a noiva evitar cabelo no ralo (Assinado Felipe - SOS)", image: "cabelonoralo.webp" },
    { title: "Cobertor para a noiva sempre coberta de razão", image: "monaiza.webp" },
    { title: "Robo para ajudar o Felipe a limpar a casa", image: "aspirador.jpeg" },
    ...
    { title: "Seguro acidente para a hora do bouquet", image: "anao.jpg" },
    ...
    { title: "Ajuda para pagar o um hotel pet para a pandora na nossa lua de mel", image: "pet.jpg" },
    { title: "Ajude o casal a pagar o vestido da noiva. Como sempre a Camila só escolhe coisa cara", image: "vestido.jpg" },
    { title: "Ajude o Felipe a não peder mais cabelos por preocupação", image: "minoxidil.webp" },
    { title: "Ajuda de custo para a Camila parar de brigar no UNO", image: "uno meme.jpg" },
    { title: "Camisa do time de coração para a alegria do noivo", image: "camisa.webp" },
    ...
    { title: "Coral para cantar “ ALELUIA” na entrada do noiva", image: "coralm.webp" },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const pricesString = ["1,50", "250,00", "200,00", "250,00", "100,00", "150,00", "250,00", "200,00", "250,00", "200,00", "150,00", "150,00", "300,00", "200,00", "350,00", "500,00", "250,00", "169,69", "150,00", "200,00", "150,00", "150,00", "350,00", "250,00", "300,00", "150,00", "250,00", "300,00", "200,00", "390,00", "250,00", "250,00", "400,00", "150,00", "350,00", "350,00", "700,00", "500,00", "250,00", "200,00", "500,00", "350,00", "500,00", "800,00", "350,00", "450,00", "350,00", "300,00", "1000,00", "350,00", "355,00", "600,00", "1500,00", "350,00", "350,00", "350,00", "800,00", "350,00", "2000,00", "400,00", "350,00", "450,00", "1500,00", "1000,00", "1000,00", "800,00", "2000,00", "1000,00", "3000,00", "3500,00"];
